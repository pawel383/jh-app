...
import pl.pawel.jhapp.domain.Employee;
import pl.pawel.jhapp.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link pl.pawel.jhapp.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
