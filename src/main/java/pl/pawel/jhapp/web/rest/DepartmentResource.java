...
import pl.pawel.jhapp.domain.Department;
import pl.pawel.jhapp.service.DepartmentService;
...
/**
 * REST controller for managing {@link pl.pawel.jhapp.domain.Department}.
 */
@RestController
@RequestMapping("/api")
